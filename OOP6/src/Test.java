...
public class Test {
	...
	public static void main(String[] args) {
		...
		SKSkin skh = new SKHochfesterSkin(), skb = new SKSensitiveSkin(), skg = new SKGepanzerterSkin();
		SWSecurityLevel sec1 = new SWSecurityLevel1(), sec2 = new SWSecurityLevel2(), sec3 = new SWSecurityLevel3(), sec4 = new SWSecurityLevel4();
		SWSoftware swg = new SWGesellschafterSoftware(sec1), swh1 = new SWHilfskraftSoftware(sec1), swh2 = new SWHilfskraftSoftware(sec2), swt3 = new SWTransportarbeiterSoftware(
				sec3), swt4 = new SWTransportarbeiterSoftware(sec4), swb3 = new SWBauarbeiterSoftware(sec3), swb4 = new SWBauarbeiterSoftware(sec4), sws3 = new SWServicetechnikerSoftware(
				sec3), sws4 = new SWServicetechnikerSoftware(sec4), swo = new SWObjektbewacherSoftware(sec4), swl = new SWLeibwaechterSoftware(sec4), swk = new SWKaempferSoftware(
				new SWSecurityLevel5());
		ASAktorenSet kw05 = new ASLameAktoren(), kw3 = new ASLeichteAktoren(), kw9 = new ASSchwereAktoren(), kw50 = new ASAwesomeAktoren();
		...
		test = new ANAndroide[] {
				...
				// Software ueberschreiben (invalid)
